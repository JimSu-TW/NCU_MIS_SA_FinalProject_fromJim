...
public class MemberHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`tb_member` WHERE `user_id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tb_member`";
    ...
    public JSONObject getByID(int id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tb_member` WHERE `user_id` = ? LIMIT 1";
    ...
    public JSONObject getByEmail(String email) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tb_member` WHERE `email` = ? LIMIT 1";
            ...
            while(rs.next()) {
                ...
                /** 將每一筆會員資料產生一名新Member物件 */
                m = new Member(member_id, get_email, password, name);
                /** 取出該名會員之資料並封裝至 JSONsonArray 內 */
                jsa.put(m.getData());
            }
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `missa`.`tb_member` WHERE `email` = ?";
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`tb_member`(`name`, `email`, `password`)"
                    + " VALUES(?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`tb_member` SET `password` = ? WHERE `email` = ?";
            /** 取得所需之參數 */
            String email = m.getEmail();
            String password = m.getPassword();
