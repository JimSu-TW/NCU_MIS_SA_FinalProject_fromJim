...
public class ManagerHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`tb_manager` WHERE `manager_id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tb_manager`";
            ...
            while(rs.next()) {
                ...
                int root = rs.getInt("root_manager");
                
                /** 將每一筆會員資料產生一名新Member物件 */
                m = new Manager(manager_id, password, root);
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tb_manager` WHERE `manager_id` = ? LIMIT 1";
    ...
    public JSONObject create(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`tb_manager`(`root_manager`, `password`)"
                    + " VALUES( ?, ?)";
            
            /** 取得所需之參數 */
            int root_manager = m.getRoot();
            String password = m.getPassword();
            
            /** 將參數回填至SQL指令當中 */
            pres = conn.prepareStatement(sql);
            pres.setInt(1, root_manager);
    ...
    public JSONObject update(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`tb_manager` SET `root_manager`=?, `password` = ? WHERE `manager_id` = ?";
            /** 取得所需之參數 */
    ...
    public boolean checkDuplicate(Manager m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `missa`.`tb_manager` WHERE `manager_id` = ?";
